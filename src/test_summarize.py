...
# 1. Normal Case — Relevant Summary and Clear Question

def test_answer_normal_case():
    summary = "The stock market crashed due to global inflation."
...
def test_answer_no_question():
    ...
    result = answer_user_question(summary, "")
